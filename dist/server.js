...
import { DEFAULT_MIO_API_URL } from './config.js';
import { MioOauth2TokenResponseSchema } from './validation.js';
/**
...
export class MioServerSDK extends BaseMioSDK {
    ...
    async exchangeCodeForTokens(code) {
        try {
            ...
            throw new Error(`Token exchange failed: ${err instanceof Error ? err.message : 'Unknown error'}`);
        }
    }
    /**
