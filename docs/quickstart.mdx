...
<Steps>
  <Step title="Register your app">
    Visit the <a href="https://app.mio.xyz/developer" target="_blank" rel="noreferrer">Mio dashboard</a>, create an OAuth client, and copy the `clientId`, `clientSecret`, and redirect URL you intend to use locally. You need these values before any code changes.
  </Step>
